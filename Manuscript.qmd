---
title: "A Layered Reliability Framework for Trustworthy AI in Education"
author:
  - name: "Luca Leisten"
  ...
  - name: "Olga Muss"
    ...
    attributes:
      equal_contributor: true
  - name: "Charles Edouard Bardyn"
    affiliation: "AI Swiss"
format:
  pdf:
    documentclass: wlscirep
    template: "Scientific_reports_template_modified.tex"
...
## Part 1: A framework for safe LLM interactions
...
### Rodin's Four-Slot Frame Engine
...
### Description of the Rodin’s frame engine
...
: Description of the four-slot {#tbl-description}
...
![Overview of the four-slot process for one turn](image1.png){#fig-overview}
...
![Potential elements of a parametrization of an interaction](image2.png){#fig-parametrization}
...
![Potential elements of the slot 1 - Input Analysis](image3.png){#fig-input-analysis}
![Another view of Input Analysis](image4.png)
...
![Potential elements of the slot 2 - Shape Prompt](image5.png){#fig-shape-prompt}
...
![Potential elements of response assessment in the slot 4 - Validate and Repair](image6.png){#fig-validate-repair}

#### Inter-Frame Communication via Shared Context
...
#### Orchestration Architecture: LangGraph State Machine
...
### Memory Management and Session Logging
...
## Part 2: Application of the framing in a school setting
...
### Description of Marty’s framing
...
![Marty’s interaction parameters](image7.png){#fig-marty-params}
...
2\.  `is_relevant`: A boolean (`true` or `false`) indicating if the message is relevant to the topic or task.  
3.  `mnemonic_progress`: A brief, one-sentence summary of the current state of the co-created mnemonic.  
...
![Input analysis for Marty’s frame](image8.png){#fig-marty-input-analysis}
...
![Shape prompt elements of Marty’s frame](image9.png){#fig-marty-shape-prompt}
...
![Output validation of Marty frame](image10.png){#fig-marty-output-validation}
